...
import { setNewPassword } from "../../redux/app/appThunks";
      ...
      <div className="box-row w-100 h-100">
        <div className="leftAuth">
          <div className="authForm">
            ...
            >
              Please set a password below to access your Fitcy Health account.
            </h2>
            <h2
              className="ptFont"
              style={{
            ...
            >
              Use Alphabets and Numbers for a stronger password
            </h2>
            <form
              method="POST"
