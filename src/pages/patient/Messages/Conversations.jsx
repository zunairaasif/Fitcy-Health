...
import { Emoji, Send } from "grommet-icons";
...
const Conversations = (props) => {
  ...
  return (
    <Box
      ...
      height={isTabletOrMobile ? "80%" : "100%"}
      // alignSelf="end"
      justify="between"
      pad={{ top: "small" }}
      style={{
        borderLeft: "1px solid #80808020",
        minHeight: isTabletOrMobile ? null : "550px",
      }}
      // background="red"
      // round="8px"
    >
      {isTabletOrMobile ? null : (
        <Box
          ...
          pad="small"
        >
          <Avatar size="medium" src={therapist.dp ? therapist.dp : noAvatar} />
      ...
      {peerID && peerID === user.current_therapist.id ? (
